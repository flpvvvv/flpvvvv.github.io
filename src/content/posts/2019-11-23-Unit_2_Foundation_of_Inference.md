...
description: Notes on estimation, confidence intervals, hypothesis testing, and the delta method from MITx Fundamentals of Statistics
date: 2019-11-23
author: flpvvvv
tags: [Statistics]
toc: true
...
- if $\Theta=\Theta _1\times \Theta_2$, where $\Theta _1$ is finite dimensional, and $\Theta_2$ is infinite dimensional, then the model is called **semiparametric**.
